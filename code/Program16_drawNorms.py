...
for user in user_dict:
    ...
    peaks_allusers.append({"user": user, "peak": tuple_peaks[0], "height": heights[0], "threshold": threshold, "change_count": change_count})
...
writer_clusters.writerow(["user", "peak", "height", "threshold", "change_count"])
